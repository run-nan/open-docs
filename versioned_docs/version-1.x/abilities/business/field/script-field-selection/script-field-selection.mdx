...
Single-select/multi-select menu script fields can be added as **issue fields**, **project fields**, and **product fields**.
...
| ObjectType | int    | Entity type, can have the following values:<br />- 1: Project<br />- 2: Task<br />- 3: Product |
