...
- **Issue**
  ...
  Call [Field.FieldsAdd](../../../../reference/packages/node-ability/node-ability.md#FieldsAdd) in your code to add script-field. For details, please refer to the document: [script-field-selection](../script-field-selection/script-field-selection.mdx)
...
- **Project**
  ...
  Call [Field.ItemsAdd](../../../../reference/packages/node-ability/node-ability.md#ItemsAdd) in code to add script-field
...
- **Params**
  ...
  The parameters of the [Field.AddGroupField](../../../../reference/packages/node-ability/node-ability.md#AddGroupField) method are as follows:
