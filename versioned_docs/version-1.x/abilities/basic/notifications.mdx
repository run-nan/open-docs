...
id: notifications
sidebar_position: 4
description: Various notification methods.
---
...
Use the [Notify](../../reference/packages/node-ability/node-ability.md#Notify) method to send a notification to the user.

Example: use the [ONES API registration](../business/ONES-API/ONES-API-registration) the ability registration API, and pass in the user `uuid` when calling the interface, and send a test email to the specified user.
