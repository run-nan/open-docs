...
sidebar_position: 3
description: 'Each plugin is allowed to log its own messages, providing four standard logging methods: debug, info, warning, and error. Additionally, the system supports exporting log files.'
---
