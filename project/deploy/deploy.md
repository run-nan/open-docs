...
<!-- ![](../../docs/plugin-dev/guide/images/oneswiki_permission.png) -->
...
<!-- ![](../../docs/plugin-dev/guide/images/ones-release-tag-01.png) -->

View by docker command:

<!-- ![](../../docs/plugin-dev/guide/images/ones-release-tag-02.png) -->
...
<!-- ![](../../docs/plugin-dev/guide/images/deploy.png) -->
...
<!-- ![](../../docs/plugin-dev/guide/images/rollback.png) -->
...
<!-- ![](../../docs/plugin-dev/guide/images/onesproject_public.png) -->
...
<!-- ![](../../docs/plugin-dev/guide/images/onesproject_private.png) -->
