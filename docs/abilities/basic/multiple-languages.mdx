...
### 1. Use multiple languages in plugin configuration files

#### Plugin basic information in multiple languages

The multi-language implementation of the basic information of the plugin is relatively simple,just follow these steps to modify the plugin configuration file.
...
:::caution
The `'{{key}'` used in replacement must be enclosed in quotation marks.
:::
...
In this way, the multi-language basic information of the plugin is realized.

---

#### Plugin configuration items and ability configuration items are multilingual

The multilingual implementation of plugin configuration items and ability configuration items is also achieved by modifying the configuration file, but requires a few additional steps.

Here, take the configuration item of the plugin as an example, the configuration item of the ability is consistent with the way the plugin configuration item is used.
...
In this way, plugin configuration items and ability configuration items also implement multiple languages.

### 2. Use multiple languages in plugin backend
...
### 3. Use multiple languages in plugin frontend
