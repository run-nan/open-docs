...
Example: use the [ONES API registration] the ability registration API, and pass in the user `uuid` when calling the interface, and send a test email to the specified user.
