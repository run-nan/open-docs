...
| title          | title of progress                                                                                                                                                 | <a href="#LanguagePkg">LanguagePkg</a> | Y        | -             |
...
| resultText  | Details                  | <a href="#LanguagePkg">LanguagePkg</a>     | Y        | -             |
| payload     | The action at completion | <a href="#ProcessResult">ProcessResult</a> | Y        | -             |
