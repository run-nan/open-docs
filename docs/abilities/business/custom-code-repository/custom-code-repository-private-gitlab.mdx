...
Developers can modify the [ones:settings:pipeline:default:repo:link](../../slot/module/configuration/pipeline/default/code-repository/index.md#onessettingspipelinedefaultrepolink) module to customize the following linked code repository pages to implement Gitlab Authentication logic and add code repository logic.
...
Then on the [ones:settings:pipeline:default:repo:link](../../slot/module/configuration/pipeline/default/code-repository/index.md#onessettingspipelinedefaultrepolink) module page, splice the redirect url according to the above rules.
...
The `about-blank` module receives the authorization code and synchronizes it to the implementation of the `ones:settings:pipeline:default:repo:link` module, please refer to [Code repository management-third-party authentication](../../slot/module/configuration/pipeline/default/code-repository/index.md#third-party-authentication).
