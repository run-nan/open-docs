...
# Custom Integration Code Repository
...
Use the `OP` command to add modules in the plugin project, select [ones:settings:pipeline:default:repo:link](../../slot/module/code_repository/index.md#onessettingspipelinedefaultrepolink) type:
...
In order to be able to add the code repositories to the ONES system, we provide the [add code repositories](../../../reference/packages/node-ability/node-ability.md#addrepos) method in the SDK method, which can be used as follows:
...
After successfully link the code repository, you can call the SDK methods [add repository commits](../../../reference/packages/node-ability/node-ability.md#addrepocommits) and [add repository pull request](../../../reference/packages/node-ability/node-ability.md#addrepopullrequest) to the ONES system.
...
In order to facilitate the query of linked code repositories information, we provide the two SDK methods [query linked single code repository](../../../reference/packages/node-ability/node-ability.md#queryrepo) and [query all linked code repositories](../../../reference/packages/node-ability/node-ability.md#queryrepos):
...
- [Scene One: Integrate the private Gitlab code repository of the specified version](./custom-code-repository-private-gitlab)
