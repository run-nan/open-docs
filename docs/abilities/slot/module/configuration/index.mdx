...
- [ones:settings:pipeline_integration](#onessettingspipeline_integration)
- [ones:settings:code_integration](#onessettingscode_integration)
...
- [ones:settings:pipeline (deprecated)](#onessettingspipeline-deprecated)
