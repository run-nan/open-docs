...
|    属性     | 说明                                                                                                                           |   类型   | 必填 | 默认值 |
| :---------: | :----------------------------------------------------------------------------------------------------------------------------- | :------: | :--: | :----: |
| moduleType  | 模块类型，可选值 [见下文](#moduletype)                                                                                         |  string  |  是  |        |
|     id      | 模块自定义标识，在插件内唯一                                                                                                   |  string  |  是  |        |
|    title    | 模块标题                                                                                                                       |  string  |  是  |        |
| description | 模块描述                                                                                                                       |  string  |  否  |        |
|    icon     | 模块图标名称，详见 [ONES Design Icons](https://bangwork.github.io/ones-design/?path=/story/icons--icon%E5%9B%BE%E6%A0%87%E5%BA%93)   |  string  |  否  |        |
|    link     | 模块的跳转链接径                                                                                                               |  string  |  否  |        |
|    entry    | 模块的入口文件路径，若 `link` 不为空，则忽略该配置项                                                                           |  string  |  否  |        |
|  disabled   | 模块是否禁用                                                                                                                   | boolean  |  否  | false  |
|   manual    | 模块是否手动触发渲染                                                                                                               | boolean  |  否  |  true  |
|   preload   | 模块是否预加载                                                                                                                 | boolean  |  否  | false  |
|   events    | 模块所使用的事件名称声明，事件名规则为 `组件:事件`，如 `modal:ok`，详见 [ONES Design](https://bangwork.github.io/ones-design/) | string[] |  否  |
|    props    | 模块对应组件的属性，详见 [ONES Design](https://bangwork.github.io/ones-design/)                                                |  object  |  否  |
...
声明一个配置中心的设置页模块，用于替换系统的「配置中心 - 账号与成员 - 第三方账号」模块
...
#### ones:settings:appearance:sider

声明一个配置中心的设置页模块，用于替换系统的「配置中心 - 系统偏好设置 - 侧边栏颜色」模块
...
声明一个配置中心的设置页模块，用于替换系统的「配置中心 - 系统偏好设置 - 浏览器 Favicon」模块
...
声明一个配置中心的设置页模块，用于替换系统的「配置中心 - 系统偏好设置 - 邮件设置」模块
...
声明一个配置中心的设置页模块，用于替换系统的「配置中心 - 系统安全 - 操作日志」模块

#### ones:settings:safe:policy

声明一个配置中心的设置页模块，用于替换系统的「配置中心 - 系统安全 - 网络访问安全策略」模块

#### ones:settings:safe:watermark

声明一个配置中心的设置页模块，用于替换系统的「配置中心 - 系统安全 - 移动端水印」模块
...
#### ones:settings:organization:order
#### ones:settings:organization:order:manage
...
#### ones:settings:organization:appearance:sider
...
#### ones:settings:subscribe

声明一个配置中心的设置页模块，用于替换系统的「配置中心 - 服务订购」模块

#### ones:settings:subscribe:update

声明一个配置中心的设置页模块，用于替换系统的「配置中心 - 服务订购 - 服务升级」模块
