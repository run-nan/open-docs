...
<font color="#FF0000"> "Illegal argument: path to file or directory is not of type string." </font> <br />
<br />
...
<font color="#FF0000">
  {' '}
  "Illegal parameter: ../file21.txt is out of range of accessible paths"{' '}
</font> <br />
