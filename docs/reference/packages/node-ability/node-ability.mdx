...
| Param    | Description                                                                                                                                                                               | Type                   | Required | Default |
| :------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------- | :------- | :------ |
| headers  | Need to include user uuid and ip address. <br /> Example: <br />{<br /> &nbsp;&nbsp;&nbsp;&nbsp;'Ones-User-Id': 'xxxxxx', <br /> &nbsp;&nbsp;&nbsp;&nbsp;'X-Real-Ip': '127.0.0.1',<br />} | Record<string, string> | Y        | -       |
| message  | Audit log information                                                                                                                                                                     | string                 | Y        | -       |
| teamUUID | Team uuid, required for organization-level plugins                                                                                                                                        | string                 | N        | -       |
...
const response = await getAbilityConfig('Qcf5BG5P')
```
...
### Field.UpdateFieldGroup {#UpdateFieldGroup}
...
### Field.UpdateScriptField {#UpdateScriptField}
...
### Job.CheckJobStatus {#CheckJobStatus}
