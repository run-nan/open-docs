...
-   [Linux](https://doc.plugins.myones.net/plugin-cli/1.1.33/plugin-cli-inter-for-linux-1.1.33.tar.gz)
-   [Windows](https://doc.plugins.myones.net/plugin-cli/1.1.33/plugin-cli-inter-for-windows-1.1.33.tar.gz)
-   [Mac-AMD64](https://doc.plugins.myones.net/plugin-cli/1.1.33/plugin-cli-inter-for-mac-amd64-1.1.33.tar.gz)
-   [Mac-ARM64](https://doc.plugins.myones.net/plugin-cli/1.1.33/plugin-cli-inter-for-mac-arm64-1.1.33.tar.gz)
...
&emsp;&emsp;&emsp;&emsp;6、输入平台服务ip和端口号，如：tcp://119.23.133.213:port
