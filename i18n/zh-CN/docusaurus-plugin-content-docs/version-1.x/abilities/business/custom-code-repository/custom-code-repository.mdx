...
在 “插件根目录” 使用 OP 命令添加插槽，选择 [ones:settings:pipeline:default:repo:link](../../slot/module/configuration/pipeline/default/code-repository/index.md#onessettingspipelinedefaultrepolink) 类型插槽：
