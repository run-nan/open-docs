...
我们为「配置中心」-「代码集成配置」- 「代码仓库关联」提供了一些插槽，以便于为该应用定制化页面模块。

当前支持的插槽：

- [ones:settings:code_integration:default:repo:link](#onessettingscode_integrationdefaultrepolink)
- [ones:settings:pipeline:default:repo:link（已废弃）](#onessettingspipelinedefaultrepolink已废弃)
...
**模块路径：** 配置中心 / 代码集成配置 / 代码仓库关联 / 关联代码仓 / 选择插件代码仓 / 下一步的弹窗
...
#### ones:settings:pipeline:default:repo:link（已废弃）
