...
- [ones:settings:pipeline:default:repo:link](#onessettingspipelinedefaultrepolink已废弃)
...
:::caution 注意
当前插槽需要使用 [集成代码仓](../../../../../../business/devops/custom-code-repository/custom-code-repository.mdx) 能力。
:::
