...
- **工作项**
  ...
  在代码中调用 [Field.FieldsAdd](../../../../reference/packages/node-ability/node-ability.mdx#FieldsAdd) 添加脚本属性。详情可参考文档： [插件承载脚本属性 - 单选/多选](../script-field-selection/script-field-selection.mdx)
...
- **项目**
  ...
  在代码中调用 [Field.ItemsAdd](../../../../reference/packages/node-ability/node-ability.mdx#ItemsAdd) 添加脚本属性
...
- **参数介绍**
  ...
  [Field.AddGroupField](../../../../reference/packages/node-ability/node-ability.mdx#AddGroupField) 方法的参数如下所示：
