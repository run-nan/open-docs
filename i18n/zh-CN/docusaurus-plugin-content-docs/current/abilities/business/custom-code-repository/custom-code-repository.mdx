...
在 “插件根目录” 使用 OP 命令添加插槽，选择 [ones:settings:pipeline:default:repo:link](../../slot/module/code_repository/index.md#onessettingspipelinedefaultrepolink) 类型插槽：
...
为了能够将插件关联的代码仓同步到 ONES 系统中来，我们在 SDK 中提供了 [添加代码仓](../../../reference/packages/node-ability/node-ability.md#addrepos) 方法：
...
关联代码仓成功后，可以调用 SDK 的 [新增代码仓提交](../../../reference/packages/node-ability/node-ability.md#addrepocommits) 和 [新增代码仓合并请求](../../../reference/packages/node-ability/node-ability.md#addrepopullrequest) 同步数据到 ONES 系统。
...
为了方便查询已关联的代码仓信息，我们提供在 SDK 中提供了 [查询已关联单个代码仓](../../../reference/packages/node-ability/node-ability.md#queryrepo) 和 [查询已关联所有代码仓](../../../reference/packages/node-ability/node-ability.md#queryrepos) 2 个方法：
...
- [场景一：集成指定版本私有 Gitlab 代码仓](./custom-code-repository-private-gitlab)
