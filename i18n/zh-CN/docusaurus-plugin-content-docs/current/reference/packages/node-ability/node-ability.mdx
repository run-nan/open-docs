...
| 参数     | 说明                                                                                                                                                                     | 类型                   | 必填 | 默认值 |
| :------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------- | :--- | :----- |
| headers  | 需包含用户 uuid 及 ip 地址。<br /> 示例: <br />{<br /> &nbsp;&nbsp;&nbsp;&nbsp;'Ones-User-Id': 'xxxxxx', <br /> &nbsp;&nbsp;&nbsp;&nbsp;'X-Real-Ip': '127.0.0.1',<br />} | Record<string, string> | 是   | -      |
| message  | 审计日志信息                                                                                                                                                             | string                 | 是   | -      |
| teamUUID | 团队 uuid, 组织级别插件该参数必填                                                                                                                                        | string                 | 否   | -      |
